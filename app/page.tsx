...
<p className="mt-4 max-w-3xl text-base md:text-lg text-neutral-300 leading-snug">
  ...
  <VisionBanner />
      ...
      {/* ===================== EXPERIENCE ===================== */}
      <Section id="experience" kicker="The Experience" title="Interactive Art Experience">
...
>
  What do <span className="font-bold drop-shadow-[0_0_4px_rgba(212,175,55,0.25)]">you</span> see?
